...
```
cd existing_repo
git remote add origin https://gitlab.com/pgalmiche/quarto-presentation-template.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/pgalmiche/quarto-presentation-template/-/settings/integrations)
